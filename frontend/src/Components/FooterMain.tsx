const FooterMain = () => {
	...
	return (
		<>
			...
			<div className={`fixed bottom-0 right-0 left-0 flex items-center justify-between pl-6 pr-6 h-16 text-sm text-neutral-400 ${idURL === "accueil" || idURL === "" || idURL === "login" ? "" : "bg-cyan-900"}`}>
				<span>© 2023</span>
